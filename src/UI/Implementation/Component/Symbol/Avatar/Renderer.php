...
class Renderer extends AbstractComponentRenderer
{
    public function render(Component\Component $component, RendererInterface $default_renderer): string
    {
        ...
        $label = htmlspecialchars($component->getLabel(), ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8');
        if ($label == "") {
        ...
        if ($component instanceof Component\Symbol\Avatar\Letter) {
            ...
            $tpl->setVariable('CUSTOMIMAGE', htmlspecialchars($component->getPicturePath(), ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8'));
        }
