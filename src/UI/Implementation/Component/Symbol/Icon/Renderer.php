...
class Renderer extends AbstractComponentRenderer
{
    ...
    public function render(Component\Component $component, RendererInterface $default_renderer): string
    {
        ...
        $tpl->setVariable("NAME", htmlspecialchars($component->getName(), ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8'));
        ...
        if ($component instanceof Component\Symbol\Icon\Standard) {
            ...
            $imagepath = htmlspecialchars($component->getIconPath(), ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8');
        }

        $ab = htmlspecialchars($component->getAbbreviation() ?? '', ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8');
        if ($ab) {
    ...
    {
        $tpl->setVariable('LABEL', htmlspecialchars($component->getLabel(), ENT_QUOTES | ENT_SUBSTITUTE, 'utf-8'));
        return $tpl;
    }
