...
class AgentTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(ObjectiveCollection::class, (new Agent($this->mock(Refinery::class)))->getUpdateObjective());
    }

    public function testGetBuildArtifactObjective(): void
    {
        $this->assertInstanceOf(NullObjective::class, (new Agent($this->mock(Refinery::class)))->getBuildArtifactObjective());
    }
