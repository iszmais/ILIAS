...
class UserCountryDefinitionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(UserCountryDefinition::class, new UserCountryDefinition($this->mock(UI::class)));
    }

    public function testFormGroup(): void
    {
        $instance = new UserCountryDefinition($this->mock(UI::class));
    ...
    {
        $instance = new UserCountryDefinition($this->mockMethod(UI::class, 'txt', ['crit_type_usr_country'], 'foo'));
        $this->assertSame('foo', $instance->translatedType());
    }

    public function testTranslatedCountry(): void
    {
        $instance = new UserCountryDefinition($this->mockMethod(UI::class, 'txt', ['meta_c_FOO'], 'foo'));
