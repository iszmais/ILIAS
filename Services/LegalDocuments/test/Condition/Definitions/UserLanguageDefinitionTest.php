...
class UserLanguageDefinitionTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf(UserLanguageDefinition::class, new UserLanguageDefinition($this->mock(UI::class), []));
    }

    public function testFormGroup(): void
    {
        $instance = new UserLanguageDefinition($this->mock(UI::class), []);
    ...
    {
        $instance = new UserLanguageDefinition($this->mockMethod(UI::class, 'txt', ['crit_type_usr_language'], 'foo'), []);
        $this->assertSame('foo', $instance->translatedType());
    }

    public function testTranslatedLanguage(): void
    {
        $instance = new UserLanguageDefinition($this->mockMethod(UI::class, 'txt', ['meta_l_foo'], 'foo'), []);
