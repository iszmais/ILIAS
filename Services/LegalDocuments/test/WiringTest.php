...
class WiringTest extends TestCase
{
    ...
    public function testAfterLogin(): void
    {
        ...
        $instance = new Wiring($this->mock(SlotConstructor::class), $this->mockMethod(Map::class, 'add', ['afterLogin', $proc], $map));
    ...
    public function testCanWithdraw(): void
    {
        ...
        $this->assertTrue(array_is_list($map['showOnLoginPage']));
        $this->assertFalse(array_is_list($map['withdraw']));
        $this->assertFalse(array_is_list($map['logout']));
        $this->assertFalse(array_is_list($map['logoutText']));
    }
    ...
    public function testShowOnLoginPage(): void
    {
        $proc = $this->fail(...);
        $instance = new Wiring($this->mock(SlotConstructor::class), new Map());
        $this->assertSame(['showOnLoginPage' => [$proc]], $instance->showOnLoginPage($proc)->map()->value());
    }
    ...
    public function testHasAgreement(): void
    {
        ...
        $this->assertFalse(array_is_list($map['agreement_public']));
        $this->assertFalse(array_is_list($map['agreement_form']));
        $this->assertTrue(array_is_list($map['intercept']));
    ...
    public function testOnSelfRegistration(): void
    {
        ...
        $instance = new Wiring($this->mock(SlotConstructor::class), $this->mockMethod(Map::class, 'add', ['self_registration', $self_registration], $map));
    ...
    public function testHasOnlineStatusFilter(): void
    {
        ...
        $instance = new Wiring($this->mock(SlotConstructor::class), $this->mockMethod(Map::class, 'add', ['filterOnlineUsers', $proc], $map));
    ...
    public function testCanReadInternalMails(): void
    {
        ...
        $instance = new Wiring($this->mock(SlotConstructor::class), $this->mockMethod(Map::class, 'add', ['constrainInternalMail', $constraint], $map));
    ...
    public function testCanUseSoapApi(): void
    {
        ...
        $instance = new Wiring($this->mock(SlotConstructor::class), $this->mockMethod(Map::class, 'add', ['useSoapApi', $constraint], $map));
    ...
    public function testHasDocuments(): void
    {
        ...
        $this->assertFalse(array_is_list($map['writableDocument']));
    }
    ...
    public function testHasUserManagementFields(): void
    {
        ...
        $instance = new Wiring(
            ...
            $this->mockMethod(Map::class, 'set', ['user_management_fields', 'foo', $proc], $map)
        );
