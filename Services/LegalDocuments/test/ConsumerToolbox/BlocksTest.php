...
class BlocksTest extends TestCase
{
    ...
    public function testUserManagementAgreeDateField(): void
    {
        ...
        $ldoc_user = $this->mockTree(User::class, ['agreeDate' => ['value' => $date]]);

        $language = $this->mock(ilLanguage::class);
        $language->expects(self::once())->method('loadLanguageModule')->with('dummy lang');
        ...
        $this->assertSame(['foo' => 'formatted date'], $proc($user));
    }
