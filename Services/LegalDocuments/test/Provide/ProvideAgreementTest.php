...
class ProvideAgreementTest extends TestCase
{
    use ContainerMock;

    public function testConstruct(): void
    {
        $this->assertInstanceOf(ProvideAgreement::class, new ProvideAgreement('foo', $this->mock(ilCtrl::class)));
    }
    ...
    public function testUrl(): void
    {
        ...
        $instance = new ProvideAgreement('foo', $ctrl);
