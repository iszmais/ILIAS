...
use ILIAS\LegalDocuments\Provide\ProvideAgreement;
...
class ProvideTest extends TestCase
{
    ...
    public function testAgreement(): void
    {
        ...
        $this->assertInstanceOf(ProvideAgreement::class, (new Provide('foo', $this->mock(Internal::class), $container))->agreement());
    }
    ...
    public function testAllowEditing(): void
    {
        ...
        $internal->expects(self::exactly(2))->method('get')->withConsecutive(['document', 'foo'], ['writableDocument', 'foo'])->willReturn($document);
