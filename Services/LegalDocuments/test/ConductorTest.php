...
class ConductorTest extends TestCase
{
    ...
    public function testLoginPageHTML(): void
    {
        ...
        $internal = $this->mockMethod(Internal::class, 'all', ['showOnLoginPage'], [
            fn() => $components,
            fn() => $components,
        ]);
    ...
    public function testLogoutText(): void
    {
        ...
        $internal = $this->mockMethod(Internal::class, 'get', ['logoutText', 'foo'], static function () use ($component): Component {
            return $component;
        });
    ...
    {
        $internal = $this->mockMethod(Internal::class, 'all', ['filterOnlineUsers'], [
            fn() => [4, 5, 6],
            fn() => [5, 6],
        ]);
    ...
    public function testUserCanReadInternalMail(): void
    {
        ...
        $internal = $this->mockMethod(Internal::class, 'all', ['constrainInternalMail'], $constraints);

        $instance = new Conductor($container, $internal, $this->mock(Clock::class));
        $this->assertInstanceOf(Transformation::class, $instance->userCanReadInternalMail());
    }
    ...
    public function testCanUseSoapApi(): void
    {
        ...
        $internal = $this->mockMethod(Internal::class, 'all', ['useSoapApi'], $constraints);
    ...
    public function testAfterLogin(): void
    {
        ...
        $internal = $this->mockMethod(Internal::class, 'all', ['afterLogin'], [
    ...
    {
        $internal = $this->mockMethod(Internal::class, 'all', ['self_registration'], [
    ...
    {
        $internal = $this->mockMethod(Internal::class, 'all', ['user_management_fields'], [
            fn() => ['foo' => 'bar', 'baz' => 'hej'],
            fn() => ['hoo' => 'har'],
        ]);
    ...
    {
        return [
            'Form type' => [ilLegalDocumentsAgreementGUI::class, 'agreement_form'],
            'Public type' => ['foo', 'agreement_public'],
        ];
    }
