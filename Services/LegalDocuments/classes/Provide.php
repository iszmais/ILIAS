...
class Provide
{
    ...
    public function agreement(): ProvideAgreement
    {
        return new ProvideAgreement($this->id, $this->container->ctrl());
    }
    ...
    {
        return new self($this->id, $this->internal, $this->container, 'writableDocument');
    }
