...
class Agent implements AgentInterface
{
    ...
    /**
     * @param list<Objectives> $objectives
     */
    private function list(array $objectives): Objective
    {
        return new ObjectiveCollection('Legal Documents', true, ...$objectives);
    }
}
