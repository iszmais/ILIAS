...
class DefaultMappings
{
    ...
    public function conditionDefinitions(): array
    {
        ...
        return [
            'usr_global_role' => new RoleDefinition($ui, $this->container['ilObjDataCache'], $this->container->rbac()->review()),
            'usr_language' => new UserLanguageDefinition($ui, $this->container->language()->getInstalledLanguages()),
            'usr_country' => new UserCountryDefinition($ui),
        ];
    }
